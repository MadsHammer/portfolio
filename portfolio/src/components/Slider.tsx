...
const Hero = () => {
  ...
  return (
    <section id="intro" className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
          <div className="lg:col-span-7 flex flex-col gap-8">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm font-bold tracking-[0.3em] text-indigo-600 uppercase">
                Portfolio
              </span>
            </div>
            ...
            <div className="max-w-2xl">
              <p className="text-xl text-gray-600 leading-relaxed">
                My name is Mads and I'm currently studying Software Development
                at Zealand. This is my portfollio website dedicated to showing
                where my interests lie, and show
                ...
                what I've made, both in my sparetime and also at Zealand as part
                of a school project.
              </p>
            </div>
          ...
          <div className="lg:col-span-5 relative max-w-120">
            <div className="aspect-square bg-gray-100 rounded-3xl overflow-hidden border border-gray-200 shadow-2xl rotate-[2deg] hover:rotate-0 transition-transform duration-500">
              ...
              <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur px-4 py-2 rounded-lg shadow-sm border border-gray-100">
                <p className="text-xs font-bold text-gray-900 uppercase tracking-tighter italic">
                  Based in Denmark
                </p>
              </div>
            </div>
