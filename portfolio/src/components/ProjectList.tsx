    ...
    <div className="max-w-6xl mx-auto px-6 py-20">
      <div className="flex flex-col gap-32">
        {projects?.map((project: Project, index: number) => (
          <div key={project.id} className="flex flex-col  border-b border-gray-100 pb-20">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              <div className="w-full lg:w-4/12">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="h-[2px] w-24 bg-indigo-200"></div>
                </div>
                <h4 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 ">{project.title}</h4>
                ...
                <div className="flex gap-6">
                  <a href={project.liveUrl} target="_blank" rel="noreferrer" className="font-bold underline decoration-2 underline-offset-4 hover:text-purple-600">Live Demo</a>
                  <a href={project.githubUrl} target="_blank" rel="noreferrer" className="font-bold underline decoration-2 underline-offset-4 hover:text-purple-600">Source Code</a>
                </div>
              </div>
