...
const About = () => {
  return (
    <section id="about" className="bg-indigo-600 text-white pt-32 pb-10  mx-auto px-6">
...
<div className="flex justify-end w-24 border-t-4 border-dotted border-indigo-200 h-0 "></div>            </div>
      ...
      I'm a straightforward guy who loves diving into deep tech rabbit holes. I'd like to see myself as positive and outgoing, trying to greet everyone with a smile. I'm both humble and have to admit to myself daily that I have a lot more to learn, I only need an internet connection and a PC and you'll find me plugging in to find the answers.
...
when GitHub finally deploys the app and everything just clicks.
  ...
  <p className="font-medium">
    When I'm not arguing with an AI about which code is cleaner or pixel-pushing a layout, you’ll find me:
  </p>
  ...
  <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
    <li className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
      ...
      <span className="text-sm font-medium uppercase tracking-wide">Running</span>
    </li>
    <li className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
      <span className="text-2xl">🎮</span>
      <span className="text-sm font-medium uppercase tracking-wide">Gaming (Comp & Casual)</span>
    </li>
    <li className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
      <span className="text-2xl">🍷</span>
      <span className="text-sm font-medium uppercase tracking-wide">Friday night wine</span>
    </li>
    <li className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
      <span className="text-2xl">🤝</span>
      <span className="text-sm font-medium uppercase tracking-wide">Friends & Family</span>
    </li>
  </ul>
          ...
          <div className="flex flex-col justify-end">
            ...
            <h3 className="text-xl font-bold text-white mb-8 uppercase tracking-widest">Reach out to me or have a look</h3>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-lg font-bold text-white group-hover:text-indigo-900 transition-colors">Email</span>
                </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-lg font-bold text-white group-hover:text-black transition-colors">GitHub</span>
                </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-lg font-bold text-white group-hover:text-[#0077B5] transition-colors">LinkedIn</span>
                </div>
